...
AAV <- all_samples_mat[,c(2,8,16,18,19,20,22,25)]
colnames(AAV) <- c("AMO25713", "AMO25715", "AMO25297", "AMO25712", "AMO25710", "AMO25294", "AMO25856", "AMO25934")


#Create DGEList object
group <- factor(c("Plxnb2_OE","Plxnb2_OE","sgNT","Plxnb2_OE","sgNT","Plxnb2_OE","sgNT")) #1 is NT 2 is OE
...
con<-makeContrasts(Plxnb2_OE - sgNT,levels=design)
...
DEGs_volcano(corrected_DEGs, 0.2, 3, "Plxnb2 vs NT", "grey",0.8, 8) #+ggsave("mets_volcano.pdf", width =8,  height=8)
...
BP_enrichment <- preranked_BP(qlf_liver$table)
View(BP_enrichment)
