...
#5. check correlation of library batches (3 independent plasmid preps, SPH1 = Hi1, SPH2 = Hi2, SPH3 = Hi3)
...
#7. check of all mice and individually 
...
#8. paired analysis of all batches (fig 3)
